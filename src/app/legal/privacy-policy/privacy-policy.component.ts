...
export class PrivacyPolicyComponent {
  ...
  sPurpose: 'TuVozATexto emplea la información con el fin de proporcionar el mejor servicio posible.',
  ...
  sRights: 'Toda persona tiene derecho a obtener información sobre el tratamiento de sus datos personales realizado por TuVozATexto.',
